...
: ${AMENT_CURRENT_PREFIX:="/home/ubuntu/workspace/ros_ur_driver/install/z_efg_f_gripper_config"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/z_efg_f_gripper_config/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/z_efg_f_gripper_config/environment/path.sh"
